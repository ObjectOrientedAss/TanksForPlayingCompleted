...
//improve this, atm it suck a lil
...
{
    float half_a_thicc = OutlineThickness * 0.5;
    ...
    uvSamples[0] = UV - float2(Texel.x, Texel.y) * half_a_thicc;
    uvSamples[1] = UV + float2(Texel.x, Texel.y) * half_a_thicc;
    uvSamples[2] = UV + float2(Texel.x * half_a_thicc, -Texel.y * half_a_thicc);
    uvSamples[3] = UV + float2(-Texel.x * half_a_thicc, Texel.y * half_a_thicc);
